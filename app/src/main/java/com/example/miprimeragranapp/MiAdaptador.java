...
public class MiAdaptador extends
    ...
    public void onBindViewHolder(ViewHolder holder, final int i) {
        ...
        holder.miitem.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v) {
                ((InterfaceToast)micontext).mensaje("El item 2 de la posición: "+ i + " Su valor es: " + lista.get(i));
            }
        });
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        ViewHolder(View itemView) {
            ...
            miitem=itemView.findViewById(R.id.miitem);
        }
    }
}
